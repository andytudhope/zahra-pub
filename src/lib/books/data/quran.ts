...
export const quranBooks: Book[] = [
    ...
    },
    {
        ...
        title: "The Qur'an: Path to Eternal Life (Hardback with Arabic)",
      ...
      {
        id: "quran-discourses",
        title: "Qur'an Discourses: A Collection of Jumu'ah Talks",
        ...
        purchaseLinks: {
          ...
          other: [
            {
              name: "Adilbris",
              url: "https://www.adlibris.com/se/bok/quran-discourses-9781776490158",
              geography: "SE"
            },
            {
              name: "Bookshop",
            ...
            {
              name: "Booktopia",
              url: "https://www.booktopia.com.au/qur-an-discourses-shaykh-fadhlalla-haeri/book/9781776490158.html",
              geography: "AU"
            },
            {
              name: "Saxo",
